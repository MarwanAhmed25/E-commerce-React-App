...
export default function Checkout(){
    ...
    function handleRegister(inputValues){
        setIsLoading(1);
        let nextProdUrl = "https://marwanahmed25.github.io/E-commerce-React-App/E-commerce-React-App/#/";
    ...
    return <>
        ...
        <div className="flex min-h-full flex-col justify-center px-6 lg:px-8">
            ...
            <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                ...
                <div>
                    <button type="submit" className="flex w-full justify-center rounded-md bg-indigo-600 px-3 py-1.5 text-sm/6 font-semibold text-white shadow-xs hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">{isLoading? "Loading...":"Checkout Now"}</button>
