...
export default function Cart(){
    ...
    let {addToCart, updatCart, removeCart, removeFormCart} = useContext(CartData);
        ...
        {cart? <section className="bg-white py-8 antialiased dark:bg-gray-900 md:py-16">
                <div className="mx-auto max-w-screen-xl px-4 2xl:px-0">
                    ...
                    {cart.products.map((product)=>{
                        <div className="space-y-6" key={product.product.id}>
                        <div className="rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 md:p-6">
                            <div className="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
                            <Link to={`/products/${product.id}`} className="shrink-0 md:order-1">
                            ...
                            <div className="flex items-center justify-between md:order-3 md:justify-end">
                                ...
                                <button onClick={()=> updatCart(product.product.id, product.count + 1)} type="button" id="increment-button" data-input-counter-increment="counter-input" className="inline-flex h-5 w-5 shrink-0 items-center justify-center rounded-md border border-gray-300 bg-gray-100 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-100 dark:border-gray-600 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700">
                            ...
                            <div className="w-full min-w-0 flex-1 space-y-4 md:order-2 md:max-w-md">
                                ...
                                <button onClick={()=> removeFormCart(product.product.id)} type="button" className="inline-flex items-center text-sm font-medium text-red-600 hover:underline dark:text-red-500">
                                    <svg className="me-1.5 h-5 w-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
